...
- (void)querySourceFeatures:(NSNumber *)viewRef
         ...
         withSourceLayerIDs:(NSArray *)withSourceLayerIDs
                    resolve:(RCTPromiseResolveBlock)resolve
                     reject:(RCTPromiseRejectBlock)reject;
- (void)setFeatureState:(NSNumber *)viewRef
              featureId:(NSString *)featureId
                  state:(NSDictionary *)state
               sourceId:(NSString *)sourceId
          sourceLayerId:(NSString * _Nullable)sourceLayerId
                resolve:(RCTPromiseResolveBlock)resolve
                 reject:(RCTPromiseRejectBlock)reject;
- (void)getFeatureState:(NSNumber *)viewRef
              featureId:(NSString *)featureId
               sourceId:(NSString *)sourceId
          sourceLayerId:(NSString * _Nullable)sourceLayerId
                resolve:(RCTPromiseResolveBlock)resolve
                 reject:(RCTPromiseRejectBlock)reject;
- (void)removeFeatureState:(NSNumber *)viewRef
                 featureId:(NSString *)featureId
